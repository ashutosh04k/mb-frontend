...
const CartItems = ({cartItem}) => {
  ...
  //   try {
  //     const userId = localStorage.getItem('cartId');
  //     await axios.post('http://localhost:5000/cart/remove-item', {
  //       userId,
  //       productId
  //     });
  //   } catch (error) {
  ...
  //   try {
  //     const userId = localStorage.getItem('cartId');
  //     const response = await axios.delete('http://localhost:5000/cart/remove-item', {
  //       data: {
  //         userId,
  //         productId
  //       }
  ...
  //     // Handle successful removal response (optional)
